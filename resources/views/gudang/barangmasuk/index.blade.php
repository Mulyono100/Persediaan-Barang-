...
<head>
    ...
    <title>Kelola Barang Masuk</title>
...
<body class="hold-transition sidebar-mini">
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="/tambahbarangmasuk" class="btn btn-primary btn-sm">Tambah Data</a>
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$b->kode_masuk}}</td>
                                                <td>{{$b->user->name}}</td>
                                                <td>{{$b->total_barang_masuk}}</td>
                                                <td>
                                                    <a href="/barangmasuk/detail/{{$b->id}}"
                                                        class="btn btn-success btn-sm">Detail</a>
                                                    <a href="#" class="btn btn-danger btn-sm hapus"
                                                        barang_id="{{$b->id}}">Hapus</a>
                                                </td>
                                            </tr>
    ...
    $(function() {
        ...
        $('.hapus').click(function() {
            ...
            swal({
                    title: "Yakin",
                    text: 'Mau menghapus Barangmasuk ini',
                    icon: "warning",
                    buttons: true,
                    dangerMode: true,
                })
                .then((willDelete) => {
                    if (willDelete) {
                        window.location = "/barangmasuk" + "/" + barang + "/hapus";
                    } else {}
                });
        });
