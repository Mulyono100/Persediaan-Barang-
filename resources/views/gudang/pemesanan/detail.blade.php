                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="demo">
                                        ...
                                        <p><strong>NAMA SUPLIER : </strong> {{$detail->nama_suplier}} </p>
                                        <p><strong>KODE PEMESANAN : </strong> {{$detail->kode_pemesanan}} </p>
                                        ...
                                        <table id="" class="table ">
                                            ...
                                            <tbody>
                                                @foreach($detail->Detailpemesanan as $d)
                                                <tr>
                                                    <td>{{$loop->iteration}}</td>
                                                    <td>{{$d->nama_barang}}</td>
                                                    <td>{{$d->jumlah_beli}}</td>
                                                    <td> Rp. <?php echo number_format($d->harga_barang, 2); ?> </td>
                                                ...
                                                <tr>
                                                    @foreach($detail->Detailpemesanan as $p)

                                                    @endforeach
                                                    <td colspan="4"><strong> TOTAL HARGA</strong></td>
                                                    <td>Rp. <?php echo number_format($p->total_harga, 2); ?> </td>
