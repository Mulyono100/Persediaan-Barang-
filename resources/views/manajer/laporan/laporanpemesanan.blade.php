                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="/dashboardmanajer">Home</a></li>
                                <li class="breadcrumb-item active">Laporan Barang Pemesanan </li>
                            </ol>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <!-- /.box-header -->
                            <div class="card-body">
                                <form action="/laporanpemesanandetail" method="POST">
                                    <div class="row">
