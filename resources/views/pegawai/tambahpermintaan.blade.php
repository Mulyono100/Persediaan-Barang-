                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="DashboardPegawai">Home</a></li>
                ...
                <div class="row">
                    <div class="col-md-10">
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <form action="/TambahPermintaan" method="POST">

                                    <div class="table-responsive">
                                        <table class="table table-hover">
                                            <thead>
                                                <tr class="item-row">
                                                    <th colspan="4">Nama Barang</th>
                                                    <th>Stock</th>
                                            ...
                                            <tbody>
                                                ...
                                                <td colspan="6" style="text-align:right;"><button type="submit"
                                                        id="submit"
    ...
    Invoice.prototype = {
        ...
        newRow: function() {
            jQuery(".item-row:last").after(
                '<tr class = "item-row"> <td colspan = "4" ><select class ="form-control namabarang select3" name = "namabarang[]" ><option selected="selected" disabled="true">-Pilih Barang-</option>@foreach($barang as $b)<option value = "{{$b->id}}">{{$b->nama_barang}}</option>@endforeach</select > </td><td><input class="form-control stock" readonly name="stock[]"type="number"></td> <td><input class = "form-control qty"name = "jumlah[]"type = "number"> </td><td><a class=' +
                $.opt.delete.substring(1) +
                'href="javascript:;" title="Remove row">Hapus</a ></td></div></tr>');
        ...
        roundNumber: function(number, decimals) {
            ...
            if (decimals < 1) {
                ...
                var cutoff = numString.lastIndexOf(".") +
                    decimals; // The point at which to truncate the number
                ...
                if (d2 >=
                    5) { // Do we need to round up at all? If not, the string will just be truncated
