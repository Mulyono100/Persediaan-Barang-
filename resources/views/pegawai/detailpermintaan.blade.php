                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="demo">
                                        <div class="row">
                                            <div class="col-6">
                                                <p><strong>NAMA PEGAWAI : </strong>{{$minta->user->name}}</p>
                                            </div>
                                            <div class="col-6">
                                                <p><strong>TANGGAL : </strong>{{$minta->tanggal}} </p>
                                            </div>
                                        </div>
                                        ...
                                        <table id="" class="table ">
                                            ...
                                            <tbody>
                                                @foreach ($minta->detailpermintaan as $m)
                                                <tr>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-md-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-4 col-md-4"><b> MENGETAHUI
                                                            GUDANG</b><br><br><br><br>
                                                        @foreach($gudang as $g)
                                                        (
                                                        {{$g->name}} )
                                                        @endforeach
